  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      ...
      <form class="navbar-form navbar-right" role="form">
        ...
        <button type="button" id ="resetSession" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-trash"></span> Empty Basket</button>
...
"""),_display_(/*189.2*/content),format.raw/*189.9*/("""
